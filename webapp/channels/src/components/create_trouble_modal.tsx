...
const CreateTroubleModal = ({
    ...
    const handleSubmit = useCallback(async () => {
        const {message, fileInfos, props: {customer_attitude, customer_name, room, channel_id, description}} = draft;
        if (!customer_name) {
            ...
            <Modal.Body>
                <FormGroup>
                    <InputGroup className='d-flex'>
                        ...
                        >
                            <Dropdown.Toggle style={{width: '68px', height:'34px', border: '1px solid rgba(var(--center-channel-color-rgb), 0.16)'}}>
                                {customerAttitudes[0]}
                            </Dropdown.Toggle>
                            <Dropdown.Menu>
