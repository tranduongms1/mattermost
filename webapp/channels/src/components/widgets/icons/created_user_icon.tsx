...
export default function CreatedUserIcon(props: any) {
    return (
        <svg {...props} width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <path d="M18 14L18 22" stroke="currentColor" stroke-width="2" stroke-linecap="round" />
            <path d="M22 18L14 18" stroke="currentColor" stroke-width="2" stroke-linecap="round" />
