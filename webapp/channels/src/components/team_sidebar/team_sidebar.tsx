...
export default class TeamSidebar extends React.PureComponent<Props, State> {
    ...
    render() {
        ...
        const customPage = ['contacts', 'news'].includes(this.props.staticPageId);
        ...
        const teams = sortedTeams.map((team: Team, index: number) => {
            return (
                <TeamButton
                    ...
                    active={!customPage && team.id === this.props.currentTeamId}
                ...
                >
                    ...
                    >
                        ...
                        <TeamButton
                            ...
                            url='news'
                            tip='Tin Tức'
                            active={this.props.staticPageId === 'news'}
                            content={(
                                <i className='icon'>
                            ...
                            switchTeam={() => {
                                this.props.actions.selectStaticPage('news');
                                this.props.actions.switchToLhsStaticPage("channels/town-square");
                            }}
                        />
                        {joinableTeams}
                    </Scrollbars>
