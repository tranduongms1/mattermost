...
export default function IssueCard() {
    ...
    const patchIssue = async (data: any) => {
        try {
            setSubmitting(true);
        } finally {
            setSubmitting(false);
            ...
            <Container>
                ...
                <FormGroup>
                    <InputGroup>
                        ...
                        />
                        <InputGroup.Button>
                            <Button style={{ height: '34px', padding: '0 12px', border: '1px solid #ccc' }}>
            ...
            <div className='post-card--info'>
                {status != 'completed' &&
                    <button
                        ...
                        onClick={() => patchIssue({priority: !priority})}
                    >
                        <TimerIcon />
                    </button>
                }
                ...
                {CustomPostActions[status]?.map(action => (
                    <button
                        ...
                        onClick={() => patchIssue({status: action.newStatus})}
                    >
