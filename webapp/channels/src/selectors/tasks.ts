...
import {EMPTY_CHANNEL_STATS} from 'reducers/tasks';
...
export const getCurrentChannelStats: (state: GlobalState) => ChannelStats = createSelector(
    ...
    getCurrentChannelId,
    getChannelStats,
    (currentChannelId: string, channelStats: RelationOneToOne<Channel, ChannelStats>): ChannelStats => {
        return channelStats[currentChannelId] || EMPTY_CHANNEL_STATS;
    },
);
